...
export default function SpiritualSovereignty(): React.ReactElement {
  ...
  return (
    <div className="min-h-screen transition-colors duration-300">
      <header className="text-center py-4 bg-gradient-to-r from-purple-700 to-blue-600 dark:from-indigo-900 dark:to-blue-900 text-gray-800 dark:text-white">
      ...
      <main className="p-4 md:p-8">
        ...
        <button
          ...
          className="w-full flex justify-between items-center p-4 rounded-lg shadow-md mb-4 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-300 border"
        >
          ...
          <div className="animate-open-accordion mb-6">
            ...
            >
              ...
              >
                <ul className="list-disc pl-5 space-y-1">
                  ...
                  <li>
                    Recognizing the "3D ego" as separate from your Higher Self.
                  </li>
                </ul>
              </SubSection>
            ...
            >
              ...
              >
                <ul className="list-disc pl-5 space-y-1">
                  <li>
                    Heart-brain coherence practices (breathwork, grounding).
                  </li>
            ...
            >
              ...
              >
                <ul className="list-disc pl-5 space-y-1">
                  ...
                  <li>
                    Using AI tools to design personalized systems (e.g., time
                    management, ethical frameworks).
                  </li>
            ...
            >
              <p className="mb-3">
                <strong>This is a self-reinforcing cycle:</strong>
              </p>
...
function Section({
  ...
  return (
    <div className="mb-4 border-gray-300 dark:border-gray-600">
      <button
        onClick={() => toggleAccordion(id)}
        className="w-full flex justify-between items-center p-4 rounded-lg shadow-md cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-300"
      >
      ...
      {isOpen && (
        <div className="rounded-lg mt-2 p-4 animate-open-accordion">
          {children}
        </div>
      )}
    </div>
...
function SubSection({
  ...
  return (
    <div className="mt-2">
      <button
        onClick={() => toggleAccordion(id)}
        className="w-full flex justify-between items-center p-3 rounded-lg shadow-sm cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-300"
      >
        <span>{title}</span>
        <ChevronDown
          className={`transform transition-transform ${
      ...
      {isOpen && (
        <div className="rounded-lg mt-1 p-3 animate-open-accordion">
